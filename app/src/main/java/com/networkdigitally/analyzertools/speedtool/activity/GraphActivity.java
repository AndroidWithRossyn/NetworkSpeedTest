...
public class GraphActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(GraphActivity.this).loadInterstitialAd(this);
        Toolbar toolbar = findViewById(R.id.graph_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        AppManage.getInstance(GraphActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
        AppManage.getInstance(GraphActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads1), ADMOB_N[0], "");
    ...
    public void onBackPressed() {
        AppManage.getInstance(GraphActivity.this).showInterstitialAd(GraphActivity.this, new AppManage.MyCallback() {
